...
/// \brief Test GpuRadarTest system
class GpuRadarTest : public InternalFixture<::testing::Test>
{
};
...
TEST_F(GpuRadarTest, IGN_UTILS_TEST_DISABLED_ON_MAC(GpuRadarBox))
{
  ...
  const auto sdfFile = std::string(PROJECT_SOURCE_PATH) +
    "/test/worlds/gpu_radar_sensor.sdf";
  ...
  EXPECT_EQ("gpu_radar::gpu_radar_link::gpu_radar", lastMsg.frame());
}
